...
@section('pageTitle')
Enter a New Water Input Entry
@stop

@section('content')

<h1>Enter a New Water Input Entry</h1>
...
<form method="POST" action="/input">
	...
	<div class="form-group">
		...
		<div class="input-group">
			<input max="3" maxlength="3" class="form-control" name="date"
				aria-describedby="input-addon" id="datePicker" autocomplete="off">
			<span class="input-group-addon" id="input-addon">Date</span>
		</div>
		
		<button type="submit" class="btn btn-primary">Add Input</button><a href="/" class="btn btn-default pull-right">Cancel</a>
	</div>
</form>
